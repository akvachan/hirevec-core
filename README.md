...
## Top 10 Features and philosophy
- Smooth registration 
	- App can only ask user to fill out up to 5 fields before giving user access to the main view
	- User can upload his CV or register via LinkedIn, Google, Apple 
- Offline access
	- In a train
